...
llm = OpenAI(api_key="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", temperature=0.9, max_tokens=500)  # Initializing OpenAI language model 
...
if process_url_clicked: 
    ...
    embeddings = OpenAIEmbeddings(openai_api_key="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", model="text-embedding-ada-002")
